...
- [ ] 목표 속도 추적 보상 추가
  - [ ] `track_lin_vel_xy_exp` 보상 항목
  - [ ] 가중치: `1.0`
  - [ ] 파라미터: `command_name="base_velocity"`, `std=0.5`

- [ ] 목표 각속도 추적 보상 추가
  - [ ] `track_ang_vel_z_exp` 보상 항목
  - [ ] 가중치: `0.5`
  - [ ] 파라미터: `command_name="base_velocity"`, `std=0.5`

- [ ] 자세 안정성 보상 추가
  - [ ] `flat_orientation_l2` 보상 항목
  - [ ] 가중치: `-1.0` (페널티)

- [ ] 발 공중 시간 보상 추가
  - [ ] `feet_air_time` 보상 항목
  - [ ] 함수: `mdp.feet_air_time_positive_biped`
  - [ ] 가중치: `0.5`
  - [ ] 파라미터 설정 확인
...
- [ ] 액션 변화율 페널티 추가
  - [ ] `action_rate_l2` 보상 항목
  - [ ] 가중치: `-0.01`

- [ ] 관절 토크 페널티 추가
  - [ ] `dof_torques_l2` 보상 항목
  - [ ] 가중치: `-0.0001`
